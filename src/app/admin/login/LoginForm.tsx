...
export default function LoginForm({
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-zinc-800">Admin password</label>
        <input
          name="password"
          type="password"
          autoFocus
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full rounded-2xl bg-zinc-900 py-3 text-sm font-semibold text-white hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
      >
